$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/main/resources/AgileTrailblazersEmailValidation.feature");
formatter.feature({
  "line": 1,
  "name": "Validation email delivery function",
  ...
  "id": "validation-email-delivery-function",
  "keyword": "Feature"
});
formatter.scenario({
  "line": 7,
  "name": "To check email delivery system",
  "description": "",
  "id": "validation-email-delivery-function;to-check-email-delivery-system",
  "type": "scenario",
  "keyword": "Scenario"
});
formatter.step({
...
formatter.step({
  "line": 9,
  "name": "User able to go  AgileTrailblazers  homepage",
  "keyword": "And "
});
formatter.step({
  "line": 10,
  "name": "User able to put valid username",
  "keyword": "When "
});
formatter.step({
  "line": 11,
  "name": "User able to put valid email",
  "keyword": "And "
});
formatter.step({
  "line": 12,
  "name": "User able to put valid Mobile phone number",
  "keyword": "And "
});
formatter.step({
  "line": 13,
  "name": "User able to put valid Office phone number",
  "keyword": "And "
});
formatter.step({
  "line": 14,
  "name": "User able to put email subject",
  "keyword": "And "
});
formatter.step({
  "line": 15,
  "name": "User able to put email Message",
  "keyword": "And "
});
formatter.step({
  "line": 16,
  "name": "User able to click Submit button",
  "keyword": "And "
});
formatter.step({
  "line": 17,
  "name": "Validate email deliveed successfully or not",
  "keyword": "Then "
});
formatter.match({
